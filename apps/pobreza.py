...
def app():
    ...
    st.subheader('Mapear população que vive abaixo da linha da pobreza')
    ...
    st.subheader("PIB per capita ao longo dos anos, a nível global")
    st.write('**Indicador 1.1.2: Mapear situação de renda da população global**')
